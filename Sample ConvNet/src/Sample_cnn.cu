...
int main() {
	...
	cnn_layers_dims.push_back(vector<int>({ 4, 3, 3, 3 }));		// OutChannels = 4	;	InChannels = 3	;	channelHeight = 3	;	channelWidth = 3
	cnn_layers_dims.push_back(vector<int>({ 5, 4, 3, 3 }));		// OutChannels = 5	;	InChannels = 4	;	channelHeight = 3	;	channelWidth = 3
	cnn_layers_dims.push_back(vector<int>({ 2, 4, 3, 3 }));		// OutChannels = 2	;	InChannels = 4	;	channelHeight = 3	;	channelWidth = 3
